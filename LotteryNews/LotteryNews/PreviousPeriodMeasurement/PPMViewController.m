...
-(void)setupBasic{
    ...
    CGRect tableFrame = CGRectMake(0, 104, kScreenWidth, CGRectGetHeight(self.view.frame)-104-tabBarHeight-64);
    if (_fromTriolionNewViewController) {
        tableFrame = CGRectMake(0, 104, kScreenWidth, CGRectGetHeight(self.view.frame)-104-tabBarHeight);
    }
